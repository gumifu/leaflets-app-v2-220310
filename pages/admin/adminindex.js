...
export default function adminIndex() {
  ...
  return (
      <div className="flex flex-col items-center justify-center bg-gray-400 h-screen overflow-y-scroll scrollbar-hide">
          <div className="flex flex-col items-center">
          <div onClick={()=>router.push('/')} className="my-2  relative w-40 h-40 hidden lg:inline-grid cursor-pointer ">
            <Image src='/logo-main-white.svg' layout='fill' className='' objectFit='contain'/>
          </div>
          <h1 className=" text-white text-5xl ">Upload Page</h1>
          </div>
                {/* Modalの中身 */}
