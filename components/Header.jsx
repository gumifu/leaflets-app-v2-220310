  ...
  return (
    <div className='  sticky top-10 m-5 z-50 '>
      <div className='flex shadow-xl shadow-gray-800 items-center justify-between m-w-6xl bg-black rounded-full bg-opacity-20 backdrop-blur-md'>
          ...
          <div onClick={()=>router.push('/')} className="ml-5 my-2 relative w-16 h-16 lg:hidden flex-shrink-0 cursor-pointer">
      ...
      <div className='relative mt-1 p-3 rounded-md max-w-sm'>
                    ...
                    <input className='flex-grow  transparent h-14 bg-gray-50 block pl-10 sm:text-sm border-gray-300 focus:ring-blue-100 rounded-full' type="text" placeholder='検索'/>
      </div>
